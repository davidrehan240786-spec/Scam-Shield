...
const LearningHubView = () => {
  ...
  const VIDEOS = [
    { id: "v1", title: "What is Cyber Fraud", url: "https://youtu.be/1Luh3tBH-8I?si=Yx8aJWF7kMlU5nte", category: "Digital Safety", desc: "A basic introduction to how cyber fraud happens and why it's a major threat." },
    ...
    { id: "v13", title: "Social Engineering Explained", url: "https://youtu.be/uvKTMgWRPw4?si=MNu5qXIw2iSsPJOx", category: "Social Engineering", desc: "How psychological manipulation is used to trick people into divulging secrets." },
    ...
    { id: "v18", title: "Public WiFi Risks", url: "https://youtu.be/XcghUy-8VRA?si=AHMtS3JrjU5-cFxi", category: "Digital Safety", desc: "Why connecting to that free airport WiFi might put your data at risk." },
    ...
    { id: "v20", title: "Instagram & Social Media Scams", url: "https://youtu.be/2_mDQJ3-0ps?si=eDQg1JA7WpKnmNtu", category: "Social Media Scam", desc: "Protect your accounts and personal life from social media predators." },
    { id: "v21", title: "Fake Job Scam Detection", url: "https://youtu.be/lN_9weFINi0?si=27Bp5wE_Y-CfNYVK", category: "Financial Scam", desc: "Identify red flags in job offers that seem too good to be true." },
    { id: "v22", title: "Romance Scam Awareness", url: "https://youtu.be/REvDIL-WLB8?si=8jw4DVv1-TvLqj8v", category: "Social Engineering", desc: "Understanding the emotional manipulation involved in catfishing and romance fraud." },
    { id: "v23", title: "Deepfake & AI Scam Awareness", url: "https://youtu.be/eJEvFDuU6bo?si=6ttEsy9pqSUbpmou", category: "Digital Safety", desc: "The next generation of scams: how AI can impersonate voices and faces." },
    { id: "v24", title: "Cyber Safety for Youth", url: "https://youtu.be/Kz2es3-XJvw?si=MG6o2Mr3mBrU9LOD", category: "Digital Safety", desc: "Helping youth navigate online learning and social spaces safely." },
    { id: "v25", title: "Cyber Safety for Senior Citizens", url: "https://youtu.be/SKOqf1Zo5bU?si=Fv6b5hcwlGPxmo35", category: "Digital Safety", desc: "Protecting our elders from being targeted by tech support and banking scammers." }
  ];
