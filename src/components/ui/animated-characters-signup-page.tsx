    ...
    try {
      ...
      if (data.user) {
        toast({
          ...
          message: `Welcome to ScamShield! Your account has been created successfully.`,
          variant: "success",
        });
      ...
      toast({
        ...
        message: err.message || "Please check your details.",
        variant: "error",
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Join ScamShield today</p>
          </div>
            ...
            <Button 
              ...
              onClick={async () => {
                ...
                if (error) {
                  ...
                  toast({ title: "Google Sign Up Failed", message: error.message, variant: "error" });
                }
              }}
            >
